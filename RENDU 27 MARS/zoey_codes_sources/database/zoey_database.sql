...
--
-- Hôte : localhost
-- Généré le : dim. 27 mars 2022 à 21:06
...
CREATE TABLE `animal_a_adopter` (
  ...
  `nom` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `sexe` tinyint(1) NOT NULL,
  `photo` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `badge` (
  ...
  `nom` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `url_icone` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `blog` (
  `id` int NOT NULL,
  `titre` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `resume` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `texte1` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `url_image` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `description_photo` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `texte2` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
(1, 'Les castors de retour à Londres', 'Après plus de quatre cents ans d’absence, plusieurs castors sont de retour dans la capitale du Royaume Uni.', 'Après plus de quatre cents ans d’absence, plusieurs castors sont de retour dans la capitale du Royaume Uni. En effet, deux de ces mammifères ont été réintroduits jeudi dernier afin de pouvoir améliorer l’éco-système londonien tout en faisant face au dérèglement climatique. Ces bâtisseurs ont donc été relâchés dans une grande enceinte de plus de six hectares, à la Forty Hall Farm, une ferme du grand Londres. Nous pouvons même espérer des bébés castors d’ici 2023.', 'article.jpg', 'Provient de Pexels', 'Il est important de savoir que ces petites bêtes sont habituellement chassées pour leur fourrure, leur viande ou encore leur glandes, qui produisent une sécrétion odorante utilisée dans la production d’arômes alimentaires. Ils avaient donc disparu des rivières britanniques durant le seizième siècle. Le gouvernement a donc décidé de tenter de réintroduire cette espèce dans la ville de Londres, espérant pouvoir préserver cette merveilleuse espèce.', '2022-03-27 22:57:16', NULL);
...
CREATE TABLE `commentaire_post` (
  ...
  `texte_commentaire` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `date_publication` datetime DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE `conversation` (
  ...
  `url_photo` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `message` (
  ...
  `texte_message` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `url_media` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
CREATE TABLE `newsletter` (
  ...
  `prenom` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
...
CREATE TABLE `post` (
  `idpost` int NOT NULL,
  `media` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `description` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `date_publication` datetime DEFAULT CURRENT_TIMESTAMP,
...
(1, '11648414398.jpeg', '', '2022-03-27 22:53:18', NULL, 2, 1);
...
(2, 'Zoé', '11648414418.jpeg', '', NULL, 1, 4);
...
CREATE TABLE `refuge` (
  ...
  `nom` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `description` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `lien` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `adresse_mail` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `telephone` int DEFAULT NULL,
  `lien_maps` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL,
  `adresse` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `url_logo` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `reponse_forum` (
  ...
  `texte_reponse` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
  `date_publication` datetime DEFAULT CURRENT_TIMESTAMP,
  `id_likes_utilisateurs` int DEFAULT NULL,
  `utilisateur_idutilisateur` int NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `utilisateur` (
  ...
  `pseudo` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `prenom` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `nom` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `adresse_mail` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `url_photo` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `date_naissance` date DEFAULT NULL,
...
(1, 'admin', '$2y$10$rCbM7RBSl9wS2G7URNHCm.UqlTI8U4ESu8zy.AsT4d9ZHHdSmYGEG', NULL, NULL, NULL, 'admin@admin.fr', 'defaultProfile.png', NULL, NULL, 'Bienvenue sur mon profil !', '2022-03-27 21:16:07', '2022-03-27 23:06:00', NULL, 1, 1);
...
--
ALTER TABLE `profil_animal_de_compagnie`
  MODIFY `idprofil_animal_de_compagnie` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
