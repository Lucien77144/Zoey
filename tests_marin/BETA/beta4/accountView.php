...
>>>>>>> 8db2a197 (feat(connect): stay connected after session expires or auto-reconnect with google)
                <?php
                if (isset($_SESSION['idUser'])) {
                    if (!verifyToken() && $account['iduser'] == $_SESSION['idUser']) {
                ?>
                    ...
                    ?>
                        <a href="index.php?action=messages&id=<?= $conv["idconversation"] ?>">
                            <li class="controlBtn">Contacter</li>
                        </a>
                    <?php }
                } else {
                    ?>
                    <a href="index.php?action=connect">
                        <li class="controlBtn">Ajouter en ami</li>
                    </a>
                    <a href="index.php?action=connect">
                        <li class="controlBtn">Contacter</li>
                    </a>
            ...
            <div class="menuAnimauxInner">
                <ul class="menuAnimauxWrapper">
                    ...
                    while ($accountAnimal = $accountAnimals->fetch()) {
                        $animalId[$i] = $accountAnimal['idanimal'];
                    ?>
