document.addEventListener("DOMContentLoaded", function(){
  ...
  // Ce script est appelé en AJAX et permet de vérifier l'arrivée ou non de nouvelles notifications (toute les minutes)
    loadNewNotifs();
        ...
        $.post(
            ...
            function (ReturnedMessage) {
              ...
              if(ReturnedMessage.includes("New notification")){
                ...
                // Retirer l'interval attendant des notifications chaque minutes
                clearInterval(getNotfiInterval);

                // Changer le favicon et l'icon de messagerie en indiquant qu'un nouveau message à été reçu
